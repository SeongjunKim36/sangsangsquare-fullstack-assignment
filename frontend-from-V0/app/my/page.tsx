...
import { fetchMyApplications } from "@/lib/mock-data";
import { formatDateKorean, getRelativeTime, isAnnouncementPassed } from "@/lib/date-utils";
import { MyApplication, ApplicationStatus } from "@/lib/types";
import {
  ArrowLeft,
  Calendar,
  Clock,
      ...
      <main className="flex-1 container mx-auto px-4 py-6 max-w-2xl">
        ...
        {!isLoading && !error && applications.length === 0 && (
          <Empty className="py-20">
            ...
            <Empty.Title>신청한 모임이 없습니다</Empty.Title>
            <Empty.Description>
              관심 있는 모임에 신청해보세요!
            </Empty.Description>
                    ...
                    <CardContent>
                      <div className="flex flex-col gap-2 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            신청일: {formatDateKorean(application.appliedAt)}
                          </span>
                        </div>
                      </div>
